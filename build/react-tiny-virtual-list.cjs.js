...
function defaultRenderWrapper(outerProps, ref, innerStyle, items) {
    return React.createElement("div", __assign({ ref: ref }, outerProps), React.createElement("div", { style: innerStyle }, items));
}
var VirtualList = /** @class */function (_super) {
    ...
    VirtualList.prototype.getStyle = function (index) {
        ...
        var _b = this.props.scrollDirection,
            scrollDirection = _b === void 0 ? DIRECTION_VERTICAL : _b;
        var _c = this.sizeAndPositionManager.getSizeAndPositionForIndex(index),
            size = _c.size,
            offset = _c.offset;
        return this.styleCache[index] = __assign({}, STYLE_ITEM, (_a = {}, _a[sizeProp[scrollDirection]] = size, _a[positionProp[scrollDirection]] = offset, _a));
    };
    ...
    VirtualList.prototype.render = function () {
        ...
        var _b = this.props,
            ...
            _d = _b.renderWrapper,
            renderWrapper = _d === void 0 ? defaultRenderWrapper : _d,
            itemCount = _b.itemCount,
            itemSize = _b.itemSize,
            onItemsRendered = _b.onItemsRendered,
            onScroll = _b.onScroll,
            _e = _b.scrollDirection,
            scrollDirection = _e === void 0 ? DIRECTION_VERTICAL : _e,
            scrollOffset = _b.scrollOffset,
            scrollToIndex = _b.scrollToIndex,
            scrollToAlignment = _b.scrollToAlignment,
            style = _b.style,
            width = _b.width,
            props = __rest(_b, ["estimatedItemSize", "height", "overscanCount", "renderItem", "renderWrapper", "itemCount", "itemSize", "onItemsRendered", "onScroll", "scrollDirection", "scrollOffset", "scrollToIndex", "scrollToAlignment", "style", "width"]);
        var offset = this.state.offset;
        var _f = this.sizeAndPositionManager.getVisibleRange({
        ...
        return renderWrapper(__assign({}, props, { onScroll: this.handleScroll, style: __assign({}, STYLE_WRAPPER, style, { height: height, width: width }) }), this.getRef, __assign({}, STYLE_INNER, (_a = {}, _a[sizeProp[scrollDirection]] = this.sizeAndPositionManager.getTotalSize(), _a)), items);
    };
